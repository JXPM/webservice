...
/**
 * Ressource « Hello » : retourne des messages de bienvenue en text/plain.
 */
@Path("hello")
...
public class HelloResource {
	...
	public Response getHelloWithHeaders(@PathParam("id") String id,
			@DefaultValue("votre serviteur") @HeaderParam("name") String name) {
		return Response.ok().header("name", name)
				.entity("Bonjour " + id + " de la part de (voir l'en-tête).").build();
	}
}
